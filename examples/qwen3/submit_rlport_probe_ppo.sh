...
echo "ALGO=$ALGO PPO_EPOCHS=$PPO_EPOCHS PPO_EXTRA_LR=$PPO_EXTRA_LR PPO_CLIP=$PPO_CLIP"
echo "RLC=$RLC AUX=$AUX REWARD=$REWARD_TYPE KL=$KL GAMMA=$GAMMA SEED=$SEED TRAIN_ITERS=$RL_TRAIN_ITERS"
