...
#SBATCH --partition=batch_short,batch_block1
...
#SBATCH --output=/lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp/rl_token_routing/benchmark_logs/conv_eval_%x_%j.out
#SBATCH --error=/lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp/rl_token_routing/benchmark_logs/conv_eval_%x_%j.err
...
PROOT=/lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp/rl_token_routing/Pai-Megatron-Patch
REPO_ROOT=${PROOT}
CONVERTOR_DIR=${PROOT}/toolkits/distributed_checkpoints_convertor
CONTAINER_IMAGE=/lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp/containers/pai-megatron-patch_25.04.sqsh
ORIGINAL_HF=/lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp/rl_token_routing/qwen-ckpts/Qwen3-235B-A22B
...
mkdir -p /lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp/rl_token_routing/benchmark_logs
...
if ls "${HF_OUTPUT_DIR}"/*.safetensors 1>/dev/null 2>&1; then
    ...
    srun --container-image="${CONTAINER_IMAGE}" \
         --container-mounts="/lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp:/lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp" \
...
echo "[convert OK] proceeding to in-job 1-node lm-eval"
...
srun --ntasks=1 --nodes=1 \
     ...
     bash -c "
         ...
         export HF_HOME=/lustre/fs1/portfolios/nvr/projects/nvr_israel_rlop/users/jonathanp/rl_token_routing/.hf_cache
