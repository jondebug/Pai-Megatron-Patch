#!/bin/bash
#SBATCH --job-name=bench_explore_a
#SBATCH --partition=interactive
#SBATCH --account=nvr_israel_rlop
#SBATCH --nodes=1
#SBATCH --gpus-per-node=4
#SBATCH --time=04:00:00
#SBATCH --output=/lustre/fsw/portfolios/nvr/users/jonathanp/rl_token_routing/benchmark_logs/bench_explore_a_%j.out
#SBATCH --error=/lustre/fsw/portfolios/nvr/users/jonathanp/rl_token_routing/benchmark_logs/bench_explore_a_%j.err
set -euo pipefail
...
RUNS=("explore_c256_ppo_aux0.003_r08" "explore_c256_ppo_gae0.95_aux0.003_r09" "explore_c256_ppo_gumbel_t0.3_aux0.003_r12" "explore_c256_ppo_gumbel_t0.3_gae0.95_aux0.003_r13")
